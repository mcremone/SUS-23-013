...
\title{Search for Dark Matter Produced in Association with a Resonant Bottom-Quark Pair}
...
\hypersetup{%
pdfauthor={Matteo Cremonesi, Seth Eisenberger, Erdem Yigit Ertorer},%
...
\input{2_cmsdetector_and_event_reco}
\input{3_simulated_samples}
\input{4_event_selection}
\input{5_background_estimation}
\input{6_results_and_interpretation}
\input{7_summary}
