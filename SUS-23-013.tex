...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  >>>>>>  latexdiff fix – keep this in HEAD only  <<<<<<  %
%  Load ulem in the real preamble, then swallow any        %
%  duplicate call that latexdiff writes after               %
%  \begin{document}.  Wrapped in the special guards so      %
%  latexdiff will not mark this as a “change”.              %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%DIF PREAMBLE
\usepackage[normalem]{ulem}

\makeatletter
% gobble two arguments if an option [...] is present, else one
\def\latexdiff@gobbleusepkg{\@ifnextchar[\@gobbletwo\@gobble}
\let\usepackage     \latexdiff@gobbleusepkg
\let\RequirePackage \latexdiff@gobbleusepkg
\makeatother
%DIF PREAMBLE END
