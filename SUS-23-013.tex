...
For the associated production of SM vector bosons and jets (\Zvvjets, hereafter referred to as \Zjets; \Zlljets, collectively referred to as \DYjets; and \Wlvjets, , collectively referred to as \Wjets), predictions with up to two partons in the final state are obtained at leading order (LO) in QCD using \MGvATNLO~\cite{Alwall:2014hca} with the MLM matching scheme~\cite{Mangano:2006rw} between the jets from the calculations of the matrix elements and the parton shower.
