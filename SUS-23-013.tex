...
%These CRs are collectively labeled WFCRs, as opposed to the ones populated by events that pass the \textsc{DeepAK15} requirement, which are labeled WPCRs.  
...
Table~\ref{tab:selection} summarizes the requirements that define the SR and CRs.
\begin{table}[!htbp]
    \centering
    
    \def\arraystretch{1}

    \caption{Summary of requirements that define the different analysis regions.}
    \label{tab:selection}
    \footnotesize
