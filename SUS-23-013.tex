...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  Latexdiff-safe ulem load – final version                %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%DIF PREAMBLE
\usepackage[normalem]{ulem}   % real load needed for diff markup

% 2-argument do-nothing macro  ⟨opt⟩  ⟨pkg⟩
\makeatletter
\newcommand*\tdr@ignorepkg[2][]{}
% when the body starts, turn *both* \usepackage and \RequirePackage
% into the harmless 2-arg version above.
\AtBeginDocument{%
  \let\usepackage\tdr@ignorepkg
  \let\RequirePackage\tdr@ignorepkg
}
\makeatother
%DIF PREAMBLE END
