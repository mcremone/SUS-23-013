...
Although the same requirement on \recoil that defines the SR is used in all single-lepton CRs, the \ptmiss in each event in these regions is required to be larger than 100\GeV in order to suppress the larger contribution from QCD multijet events due to jets faking electrons in these regions. 
