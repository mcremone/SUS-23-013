...
\def\svnVersion{a097537-D}\def\svnDate{2024/10/29}
...
\begin{table}[H]
    ...
    \caption{Expected yields from background processes in the signal region. Values are pre-fit and uncertainties are statistical-only.}
    \label{sr_yields}
    \footnotesize
